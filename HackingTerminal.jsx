...
const HackingTerminal = () => {
  ...
  const unlockAchievement = (achievementKey, message, points = 0) => {
    if (!achievements[achievementKey]) {
      ...
      addOutput(`║ Points: +${points.toString().padEnd(38)} ║`, 'achievement');
      addOutput('╚══════════════════════════════════════════════════╝', 'achievement');
      addOutput('', 'output');
    }
  };
  ...
  const compromiseHost = (targetIP) => {
    if (!compromisedHosts.includes(targetIP)) {
      ...
      addOutput(`║ Points Earned: +${host.value.toString().padEnd(32)} ║`, 'success');
      addOutput('╚═══════════════════════════════════════════════════╝', 'success');
      addOutput('', 'output');
  ...
  const showVictoryScreen = () => {
    ...
    addOutput(`║ Time: ${minutes}m ${seconds}s${' '.repeat(Math.max(0, 50 - (minutes.toString().length + seconds.toString().length + 3)))} ║`, 'victory');
    addOutput('╚═══════════════════════════════════════════════════════════╝', 'victory');
    addOutput('', 'output');
