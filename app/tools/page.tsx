  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-black">
      ...
      >
        ...
        <WrenchScrewdriverIcon className="w-5 h-5 sm:w-6 sm:h-6 text-green-500" />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        >
          ...
          <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-xl p-6">
            <h2 className="text-xl sm:text-2xl font-bold text-green-400 mb-4">🔧 Developer Tools</h2>
            <p className="text-slate-300 leading-relaxed">
              Access developer tools, settings, and utilities to customize your Atlas experience.
            </p>
          </div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-black/60 via-slate-900/60 to-black/60 backdrop-blur-xl border border-slate-700/50 rounded-xl p-6"
          >
