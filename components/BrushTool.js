...
class BrushTool {
  constructor() {
    this.size = 1; // Brush size in tiles
    this.shape = 'square'; // 'square', 'circle', 'line'
    this.mode = 'paint'; // 'paint', 'erase', 'fill', 'eyedropper'
    this.pattern = null; // For pattern brushes (future feature)
    this.lastPosition = null; // For line drawing
  }
